    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-7 col-md-12">
                <!-- about-img -->
                <div class="about-img ">
                    <img src="/assets/hc/assets/img/gallery/about.png" alt="">
                </div>
            </div>
...
<!-- About-2 Area End -->
<section class="wantToWork-area section-bg3" data-background="/assets/hc/assets/img/gallery/section_bg01.png">
    <div class="container">
